                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">添加图像信息</h3>
                        </div>

                        <s:form enctype="multipart/form-data" namespace="/" class="form-horizontal"
                                action="uploadAction_uploadPatientPic.action" name="myform">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <s:file cssClass="form-control" name="clqsj"></s:file>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <s:file cssClass="form-control" name="clhsj"></s:file>
                                    </div>
                                </div>
