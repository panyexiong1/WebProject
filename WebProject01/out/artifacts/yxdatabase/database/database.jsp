...
<script type="text/javascript">
	...
	/* 	function showPET() {
			...
			document.getElementById("title1").innerText = "PET数据";
		} */
		...
		<div class="row">
			<div>
				...
				<div>
					<span> <a class="btn btn-default"
						href="${pageContext.request.contextPath}/servlet/pageServlet">显示全部</a>
					</span> <span><a class="btn btn-default"
						href="${pageContext.request.contextPath}/database/addPatient.jsp">添加患者
					</a></span>
			...
			<div class="table-responsive" style="width:50%;float:left; ">
				<table class="table table-bordered">
					...
					<tbody>
						<c:forEach items="${pb.patient }" var="patient">
							<tr>
								<%-- <td><a
									href="${pageContext.request.contextPath}/servlet/findPatientByIDServlet?ID=${patient.ID }">${patient.ID }</a></td> --%>
								<td><a
									href="${pageContext.request.contextPath}/servlet/findPatientByIDServlet?ID=${patient.ID }">${patient.name }</a></td>
								<td>${patient.sex }</td>
				...
				<div align="center">
					<ul class="pagination">
						...
						<li><a
							href="${pageContext.request.contextPath }/servlet/pageServlet?currentPage=${pb.currentPage==pb.totalPage?pb.totalPage:pb.currentPage+1}">下一页</a></li>
					</ul>
				</div>
			</div>
										...
										<c:if test="${! empty patientall.FDGDate}">
											<tr>
												...
												<td style="width: 250px"><a
													href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.FDGDate }&leixing=FDGDate&pic=${patientall.FDGpic }&shuju=FDGpic">${patientall.FDGpic}</a></td>
									...
									<tbody>
										<c:if test="${! empty patientall.CFTDate}">
											<tr>
												...
												<td style="width: 250px"><a
													href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.CFTDate }&leixing=CFTDate&pic=${patientall.CFTpic }&shuju=CFTpic">${patientall.CFTpic}</a></td>
									...
									<tbody>
										<c:if test="${! empty patientall.VMATDate}">
											<tr>
												...
												<td style="width: 250px"><a
													href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.VMATDate }&leixing=VMATDate&pic=${patientall.VMATpic }&shuju=VMATpic">${patientall.VMATpic}</a></td>
									...
									<tbody>
										<c:if test="${! empty patientall.TAUDate}">
											<tr>
												...
												<td style="width: 250px"><a
													href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.TAUDate }&leixing=TAUDate&pic=${patientall.TAUpic }&shuju=TAUpic">${patientall.TAUpic}</a></td>
									...
									<tbody>
										<c:if test="${! empty patientall.MRIDate}">
											<tr>
												...
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlASL }&shuju=xlASL">${patientall.xlASL}</a></td>
												
												<td style="width: 250px">
													<c:if test="${empty patientall.xlASLclh }">
														<input type="file" size="5" name="xlASLclh">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlASLclh }&shuju=xlASLclh">${patientall.xlASLclh}</a></td>
												
												<td style="width: 250px">
													<c:if test="${empty patientall.xlBOLD }">
														<input type="file" size="5" name="xlBOLD">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlBOLD }&shuju=xlBOLD">${patientall.xlBOLD}</a></td>
												
												<td style="width: 250px">
													<c:if test="${empty patientall.xlBOLDclh }">
														<input type="file" size="5" name="xlBOLDclh">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlBOLDclh }&shuju=xlBOLDclh">${patientall.xlBOLDclh}</a></td>
												
												<td style="width: 250px">
													<c:if test="${empty patientall.xlDTI }">
														<input type="file" size="5" name="xlDTI">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlDTI }&shuju=xlDTI">${patientall.xlDTI}</a></td>
												
												<td style="width: 250px">
													<c:if test="${empty patientall.xlDTIclh }">
														<input type="file" size="5" name="xlDTIclh">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=${patientall.xlDTIclh }&shuju=xlDTIclh">${patientall.xlDTIclh}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.jcqzd }">
														<input type="text" size="5" name="jcqzd">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=jcqzd">${patientall.jcqzd}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.zdlczd }">
														<input type="text" size="5" name="zdlczd">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=zdlczd">${patientall.zdlczd}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.UPDRS }">
														<input type="text" size="5" name="UPDRS">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=UPDRS">${patientall.UPDRS}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.HY }">
														<input type="text" size="5" name="HY">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=HY">${patientall.HY}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.height }">
														<input type="text" size="5" name="height">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=height">${patientall.height}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.weight }">
														<input type="text" size="5" name="weight">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=weight">${patientall.weight}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.xuetang }">
														<input type="text" size="5" name="xuetang">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=xuetang">${patientall.xuetang}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.qibingsj }">
														<input type="text" size="5" name="qibingsj">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=qibingsj">${patientall.qibingsj}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.bingcheng }">
														<input type="text" size="5" name="bingcheng">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=bingcheng">${patientall.bingcheng}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.qibingzhiti }">
														<input type="text" size="5" name="qibingzhiti">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=qibingzhiti">${patientall.qibingzhiti}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.DM }">
														<input type="text" size="5" name="DM">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=readme.txt&shuju=DM">${patientall.DM}</a></td>
												
												<td style="width: 100px">
													<c:if test="${empty patientall.beizhu }">
														<input type="text" size="5" name="beizhu">
													</c:if> 
												<a href="${pageContext.request.contextPath }/servlet/downloadServlet?ID=<%=request.getParameter("ID")%>&date=${patientall.MRIDate }&leixing=MRIDate&pic=$readme.txt&shuju=beizhu">${patientall.beizhu}</a></td>
